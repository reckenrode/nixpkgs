...
stdenv.mkDerivation (finalAttrs: {
  ...
  #
  #  preBuild =
  #    # Make sure the build prefers the stdlib built along with the stage 1 compiler by building it first.
  #    lib.optionalDrvAttr (bootstrapStage == 1 && stdenv.hostPlatform.isLinux && swift_release == "6.3.3")
  #      ''
  #        prependToVar NIX_LDFLAGS -L$NIX_BUILD_TOP/build/lib/swift/${swiftPlatform}/${stdenv.hostPlatform.swift.arch}
  #        ninja -j$NIX_BUILD_CORES stdlib
  #      '';
